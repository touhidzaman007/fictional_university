...
class Search {
  ...
  // 3. Methods will live (function, action...)
  ...
  getResults() {
      ...
      this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.programs.length ? '<ul class="min-list link-list">' : `<p>No programs matches that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
                    ...
                    <div class="one-third">
                        ...
                        ${results.campuses.length ? '<ul class="min-list link-list">' : `<p>No campuses matches that search. <a href="${universityData.root_url}/campuses">View all campuses</a></p>`}
    ...
    //     this.resultsDiv.html(`
    //     <h2 class="search-overlay__section-title">General Information</h2>
    //     ${combinedResult.length ? '<ul class="min-list link-list">' : '<p>No general information matches that search.</p>'}
